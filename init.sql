...
CREATE TABLE games(id int AUTO_INCREMENT, url VARCHAR(60), datePlayed VARCHAR(15), whiteName VARCHAR(25), blackName VARCHAR(25), winner VARCHAR(20), numMoves int, moves VARCHAR(800), checkmate VARCHAR(5), UNIQUE (url), PRIMARY KEY (id));
