...
CREATE TABLE games(id int AUTO_INCREMENT, url VARCHAR(60), datePlayed VARCHAR(15), whiteName VARCHAR(25), blackName VARCHAR(25), opening VARCHAR(100), winner VARCHAR(20), numMoves int, moves VARCHAR(850), UNIQUE (url), PRIMARY KEY (id));
